...
$WorkRoot   = Join-Path $RepoRoot "scripts\_work\triad_archive_negative_output_not_empty_v1"
...
Write-Utf8NoBomLf (Join-Path $OutputDir "already_here.txt") "occupied"
...
if($r2.Output -notmatch "OUTPUT_DIR_NOT_EMPTY"){ Die ("EXPECTED_FAILURE_TOKEN_NOT_FOUND: " + $r2.Output) }

Write-Host ("NEG_OUTPUT_DIR: " + $OutputDir) -ForegroundColor DarkGray
Write-Host "TRIAD_ARCHIVE_NEGATIVE_OUTPUT_NOT_EMPTY_V1_SELFTEST_OK" -ForegroundColor Green
